      ...
      <article className="max-w-4xl mx-auto bg-purple-950/20 border border-purple-900/50 rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="px-6 md:px-12 py-10">
         ...
         {/* THE UPGRADED RICH TEXT RENDERER */}
          ...
          {/* --- THE ACTION BAR --- */}
          <div className="mt-12 pt-8 border-t border-purple-900/50 flex flex-col sm:flex-row items-center justify-between gap-6">
            <NewsLikeButton slug={resolvedParams.slug} />
            
            {/* A quick jump-to-comments button for smooth UX */}
            <a href="#comments" className="text-sm font-bold text-purple-400 hover:text-pink-400 uppercase tracking-widest transition-colors flex items-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
              Discuss This
            </a>
          </div>

          {/* THE NEW COMMENTS ENGINE! */}
          <div id="comments">
            <NewsComments slug={resolvedParams.slug} />
          </div>
